...
})(window,document,'script','dataLayer','GTM-P4D6CFZ');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P4D6CFZ"
...
<!-- End Google Tag Manager (noscript) -->
						...
						<nav role="navigation">
							<div id="menuToggle">
								...
								<ul id="menu">
									...
									<li><a href="tratamento-ambulatorial.php">Ambulatorial</a></li>
	...
	<div class="buttons-fixed bottomFix">
		<div class="flex">
			...
			<a href="https://api.whatsapp.com/send?phone=5581999401008&text=Olá gostaria de conversar sobre tratamento ambulatorial" target="_blank" class="btn-fix" title="Atendimento por Whatsapp | Grupo Recanto - Clínica de reabilitação para dependentes químicos" alt="Atendimento por Whatsapp | Grupo Recanto - Clínica de reabilitação para dependentes químicos">Tratamento Ambulatorial, clica aqui</a>
			<a href="https://api.whatsapp.com/send?phone=5581997610300&text=Olá gostaria de conversar sobre internações" target="_blank" class="btn-fix" title="Atendimento por Whatsapp | Grupo Recanto - Clínica de reabilitação para dependentes químicos" alt="Atendimento por Whatsapp | Grupo Recanto - Clínica de reabilitação para dependentes químicos">Internações, clica aqui</a>
		</div>
	</div>